...
3. Startup/reset complaints: look for quarantined `.corrupt.*` files in the support folder.
4. Crash complaints: inspect `exception_type`, `exception_message`, and traceback frames in the crash report.
