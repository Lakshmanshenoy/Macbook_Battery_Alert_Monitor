...
BattMon is a lightweight, open-source macOS menu-bar app that watches your battery in real time and alerts you — with sound, voice, and notifications — before it runs out.
...
1. Download `BattMon.dmg` from this release
2. Double-click to mount
3. Drag **BattMon.app** to your **Applications** folder
4. Eject the DMG
5. Launch **BattMon** from Applications
...
| File | Description |
|---|---|
| `BattMon.dmg` | Unsigned macOS installer |
